# This code is used to evaluate the IDRNet model on the DTU dataset
# Kindly offered in the repository https://github.com/jzhangbs/DTUeval-python in order to avoid using Matlab Original DTU evaluation code
