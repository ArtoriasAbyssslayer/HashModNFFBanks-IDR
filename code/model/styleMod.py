...
"""
    ...
    The styleblock modulation and demodulation is implemented as follows:
        The conv2d layer basically Autoencodes the input feature maps in order
        to make the network learn the style of the input feature maps.
